...
function renderFlaggedEvents() {
  ...
  document.querySelector("#add-event-form").addEventListener("submit", async function(e) {
      ...
      const eventData = {
          ...
          remarks: remarks,
          location: location,
          attachments: attachments // Pass the single string directly
      };
  ...
  async function editEvent(eventId) {
      ...
      document.getElementById('edit-eventType').value = event.type;
      ...
      document.getElementById('edit-attachments').value = event.attachments; // No need to access array index
  ...
  document.getElementById('edit-event-form').addEventListener('submit', async (e) => {
      ...
      const type = document.getElementById("edit-eventType").value;
...
function downloadExcelTemplate() {
    ...
    const dropdowns = {
      ...
      'B': ['Workshop', 'Seminar', 'FDP', 'STP', 'Competition']
    };
